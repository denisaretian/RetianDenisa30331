...
public class ExecutionThread extends Thread {
	...
	public ExecutionThread(ReentrantLock l1, ReentrantLock l2, int act_min, int act_max, int activity_min, int activity_max, int sleep) {
		this.l1 = l1;
		this.l2 = l2;
	...
	public void run() {
        ...
        l1.unlock(); System.out.println(this.getName() + " - unlocked l1");
        l2.unlock(); System.out.println(this.getName() + " - unlocked l2");
